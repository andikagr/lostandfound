    ...
    <div class="split-right">
        <div class="login-box">
            ...
            <form method="POST" action="/login">
                ...
                <!-- Mockup says Username but backend validation uses email. So we name it email for functionality, but label as Username as requested -->
                <div class="form-group">
                    <label class="form-label">Username</label>
                    <input type="email" name="email" class="form-control" placeholder="Masukkan username Anda" required>
                </div>
